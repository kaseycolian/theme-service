/* theme-service v0.1.1 — theme-select.js  (GENERATED; theme list mirrors themes.index.json)
...
(function () {
  var THEMES = [{"id":"","label":"Auto (Rink Classic)"},{"id":"rink-classic-dark","label":"Rink Classic · Dark"},{"id":"midnight-arcade-dark","label":"Midnight Arcade · Dark"},{"id":"hot-neon-dark","label":"Hot Neon · Dark"},{"id":"synthwave-sunset-dark","label":"Synthwave Sunset · Dark"},{"id":"acid-arcade-dark","label":"Acid Arcade · Dark"},{"id":"rink-classic-light","label":"Rink Classic · Light"},{"id":"midnight-arcade-light","label":"Midnight Arcade · Light"},{"id":"hot-neon-light","label":"Hot Neon · Light"},{"id":"synthwave-sunset-light","label":"Synthwave Sunset · Light"},{"id":"acid-arcade-light","label":"Acid Arcade · Light"}];
  function ready(fn) {
